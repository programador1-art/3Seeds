<?php
  ...
  $this->arr_buttons['bstepretorna']['image'] = 'scriptcase__NM__nm_Scriptcase7_SoftGray_bretorna.gif';
  ...
  $this->arr_buttons['bstepavanca']['image'] = 'scriptcase__NM__nm_Scriptcase7_SoftGray_bavanca.gif';
