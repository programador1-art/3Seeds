<?php
header('Location: zona-norte.php');
exit;
...
<body>
    ...
    <!--Sliders Section-->
    <section>
        <div class="banner-1 cover-image sptb-2 sptb-tab bg-background2" data-image-src="..//images/3Seeds-min.png"
            style="background: url(&quot;..///images/3Seeds-min.png&quot;) center center;">
            <div class="header-text mb-0">
                <div class="container">
                    <div class="text-center text-white mb-7">
                        <h1 class="mb-1">3Seeds Commercial</h1>
                        <p class="mt-5">En el competitivo mundo de bienes raíces, la clave para el éxito radica en la
                            exposición adecuada de tu propiedad. En 3Seeds Commercial entendemos tus necesidades y
                            estamos aquí para superar tus expectativas, nuestra tecnología de punta asegura que tu
                            inversión inmobiliaria rinda frutos.</p>
    ...
    <section>
        <div class="bg-dark" style="background-color: green; padding-top: 80px; padding-bottom: 80px;">
            <div class=" pb-5"><img src="../images/logo-blanco.png" alt="3Seeds Commercial" width="200px"
            ...
            <div class="container-fluid h-100">
                <div class="row w-100">
                    <div class="col v-center">
                        <a href="/zona-norte.php" class="d-block mx-auto"><button class="btn btn-zonas d-block mx-auto"
                                style="border-radius: 30px;"> Zona Norte </button></a>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid h-100">
                <div class="row w-100">
                    <div class="col v-center">
                        <a href="/zona-centro.php" class="d-block mx-auto"><button class="btn btn-zonas d-block mx-auto"
                                style="border-radius: 30px;"> Zona Centro </button></a>
                    </div>
                </div>
            </div>
