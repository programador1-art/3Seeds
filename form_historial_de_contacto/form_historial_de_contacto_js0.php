<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="idhistorial_de_contacto_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['idhistorial_de_contacto_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_historial_de_contacto"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_historial_de_contacto_submit_form(y, z);
