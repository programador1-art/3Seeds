...
if (!isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['form_historial_de_contacto']['upload_field_info']) || !isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['form_historial_de_contacto']['upload_field_info'][ $_POST['param_field'] ]))
{
    exit;
}

$aUploadInfo = $_SESSION['sc_session'][ $_POST['param_seq'] ]['form_historial_de_contacto']['upload_field_info'][ $_POST['param_field'] ];
