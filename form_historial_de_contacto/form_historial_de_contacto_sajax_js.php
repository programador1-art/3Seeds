  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_historial_de_contacto" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_historial_de_contacto_form();
	}
...
?>
  ...
  // ---------- Validate fecha_
  function do_ajax_form_historial_de_contacto_validate_fecha_(iNumLinha)
  {
    var nomeCampo_fecha_ = "fecha_" + iNumLinha;
    var var_fecha_ = scAjaxGetFieldHidden(nomeCampo_fecha_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_historial_de_contacto_validate_fecha_(var_fecha_, iNumLinha, var_script_case_init, do_ajax_form_historial_de_contacto_validate_fecha__cb);
  } // do_ajax_form_historial_de_contacto_validate_fecha_

  function do_ajax_form_historial_de_contacto_validate_fecha__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_historial_de_contacto_validate_fecha__cb

  // ---------- Validate nombre_
  function do_ajax_form_historial_de_contacto_validate_nombre_(iNumLinha)
  {
    var nomeCampo_nombre_ = "nombre_" + iNumLinha;
    var var_nombre_ = scAjaxGetFieldText(nomeCampo_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_historial_de_contacto_validate_nombre_(var_nombre_, iNumLinha, var_script_case_init, do_ajax_form_historial_de_contacto_validate_nombre__cb);
  } // do_ajax_form_historial_de_contacto_validate_nombre_

  function do_ajax_form_historial_de_contacto_validate_nombre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_historial_de_contacto_validate_nombre__cb

  // ---------- Validate telefono_
  function do_ajax_form_historial_de_contacto_validate_telefono_(iNumLinha)
  {
    var nomeCampo_telefono_ = "telefono_" + iNumLinha;
    var var_telefono_ = scAjaxGetFieldText(nomeCampo_telefono_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_historial_de_contacto_validate_telefono_(var_telefono_, iNumLinha, var_script_case_init, do_ajax_form_historial_de_contacto_validate_telefono__cb);
  } // do_ajax_form_historial_de_contacto_validate_telefono_

  function do_ajax_form_historial_de_contacto_validate_telefono__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_historial_de_contacto_validate_telefono__cb

  // ---------- Validate email_
  function do_ajax_form_historial_de_contacto_validate_email_(iNumLinha)
  {
    var nomeCampo_email_ = "email_" + iNumLinha;
    var var_email_ = scAjaxGetFieldText(nomeCampo_email_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_historial_de_contacto_validate_email_(var_email_, iNumLinha, var_script_case_init, do_ajax_form_historial_de_contacto_validate_email__cb);
  } // do_ajax_form_historial_de_contacto_validate_email_

  function do_ajax_form_historial_de_contacto_validate_email__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_historial_de_contacto_validate_email__cb

  // ---------- Validate mensaje_
  function do_ajax_form_historial_de_contacto_validate_mensaje_(iNumLinha)
  {
    var nomeCampo_mensaje_ = "mensaje_" + iNumLinha;
    var var_mensaje_ = scAjaxGetFieldText(nomeCampo_mensaje_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_historial_de_contacto_validate_mensaje_(var_mensaje_, iNumLinha, var_script_case_init, do_ajax_form_historial_de_contacto_validate_mensaje__cb);
  } // do_ajax_form_historial_de_contacto_validate_mensaje_

  function do_ajax_form_historial_de_contacto_validate_mensaje__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_historial_de_contacto_validate_mensaje__cb

  // ---------- Validate metodo_contacto_
  function do_ajax_form_historial_de_contacto_validate_metodo_contacto_(iNumLinha)
  {
    var nomeCampo_metodo_contacto_ = "metodo_contacto_" + iNumLinha;
    var var_metodo_contacto_ = scAjaxGetFieldSelect(nomeCampo_metodo_contacto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_historial_de_contacto_validate_metodo_contacto_(var_metodo_contacto_, iNumLinha, var_script_case_init, do_ajax_form_historial_de_contacto_validate_metodo_contacto__cb);
  } // do_ajax_form_historial_de_contacto_validate_metodo_contacto_

  function do_ajax_form_historial_de_contacto_validate_metodo_contacto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "metodo_contacto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "metodo_contacto_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "metodo_contacto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "metodo_contacto_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_historial_de_contacto_validate_metodo_contacto__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_historial_de_contacto_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_historial_de_contacto_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_historial_de_contacto_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_historial_de_contacto_add_new_line_cb);
  } // do_ajax_form_historial_de_contacto_add_new_line

  function do_ajax_form_historial_de_contacto_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_historial_de_contacto_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_historial_de_contacto_backup_line(iNumLinha)
  {
    var var_idhistorial_de_contacto_ = scAjaxGetFieldText("idhistorial_de_contacto_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_historial_de_contacto_backup_line(var_idhistorial_de_contacto_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_historial_de_contacto_backup_line_cb);
  } // do_ajax_form_historial_de_contacto_backup_line

  function do_ajax_form_historial_de_contacto_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_historial_de_contacto_backup_line_cb

  function do_ajax_form_historial_de_contacto_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_historial_de_contacto_cancel_insert

  function do_ajax_form_historial_de_contacto_cancel_update(iSeqVert)
  {
    do_ajax_form_historial_de_contacto_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_historial_de_contacto_cancel_update

  function do_ajax_form_historial_de_contacto_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_historial_de_contacto_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_historial_de_contacto_table_refresh()
  {
    var var_idhistorial_de_contacto_ = document.F2.idhistorial_de_contacto_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_historial_de_contacto_table_refresh(var_idhistorial_de_contacto_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_historial_de_contacto_table_refresh_cb);
  } //  do_ajax_form_historial_de_contacto_table_refresh

  function do_ajax_form_historial_de_contacto_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idhistorial_de_contacto_.value = scAjaxGetKeyValue("idhistorial_de_contacto_");
    ...
    scAjaxAlert(do_ajax_form_historial_de_contacto_table_refresh_cb_after_alert);
  } // do_ajax_form_historial_de_contacto_table_refresh_cb
  function do_ajax_form_historial_de_contacto_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_historial_de_contacto_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_historial_de_contacto_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_historial_de_contacto_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_fecha_ = scAjaxGetFieldHidden("fecha_" + iNumLinha);
    ...
    var var_metodo_contacto_ = scAjaxGetFieldSelect("metodo_contacto_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_historial_de_contacto_submit_form(var_fecha_, var_nombre_, var_telefono_, var_email_, var_mensaje_, var_metodo_contacto_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_historial_de_contacto_submit_form_cb);
  } // do_ajax_form_historial_de_contacto_submit_form

  function do_ajax_form_historial_de_contacto_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("metodo_contacto_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_historial_de_contacto_submit_form_cb_after_alert);
  } // do_ajax_form_historial_de_contacto_submit_form_cb
  function do_ajax_form_historial_de_contacto_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_historial_de_contacto_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_historial_de_contacto_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_historial_de_contacto_navigate_form, function() {});
    } else {
      perform_ajax_form_historial_de_contacto_navigate_form();
    }
  }

  function perform_ajax_form_historial_de_contacto_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_historial_de_contacto_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("metodo_contacto_" + iNavForm);
    }
    var var_idhistorial_de_contacto_ = document.F2.idhistorial_de_contacto_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_historial_de_contacto_navigate_form(var_idhistorial_de_contacto_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_historial_de_contacto_navigate_form_cb);
  } // do_ajax_form_historial_de_contacto_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_historial_de_contacto']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_historial_de_contacto_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idhistorial_de_contacto_.value = scAjaxGetKeyValue("idhistorial_de_contacto_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_historial_de_contacto_navigate_form_cb_after_alert);
  } // do_ajax_form_historial_de_contacto_navigate_form_cb
  function do_ajax_form_historial_de_contacto_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_historial_de_contacto_navigate_form_cb_after_alert
  function sc_hide_form_historial_de_contacto_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "metodo_contacto_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["metodo_contacto_" + iNumLinha] = {"label": "Metodo de contacto<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["metodo_contacto_"][iNumLinha] = "metodo_contacto_" + iNumLinha;
    ...
    ajax_field_id["metodo_contacto_" + iNumLinha] = new Array("hidden_field_label_metodo_contacto_", "hidden_field_data_metodo_contacto_" + iNumLinha);
    ...
    ajax_error_count["metodo_contacto_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["metodo_contacto_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["metodo_contacto_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["metodo_contacto_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["metodo_contacto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["metodo_contacto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["metodo_contacto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["metodo_contacto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["metodo_contacto_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['metodo_contacto_'])) ? $this->nmgp_cmp_readonly['metodo_contacto_'] : 'off';
?>
    scAjaxFieldRead("metodo_contacto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("metodo_contacto_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["fecha_" + iRow] || "on" == ajax_error_count["nombre_" + iRow] || "on" == ajax_error_count["telefono_" + iRow] || "on" == ajax_error_count["email_" + iRow] || "on" == ajax_error_count["mensaje_" + iRow] || "on" == ajax_error_count["metodo_contacto_" + iRow]))
    {
      ...
      $("#hidden_field_data_metodo_contacto_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["fecha_" + iRow] && "off" == ajax_error_count["nombre_" + iRow] && "off" == ajax_error_count["telefono_" + iRow] && "off" == ajax_error_count["email_" + iRow] && "off" == ajax_error_count["mensaje_" + iRow] && "off" == ajax_error_count["metodo_contacto_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["metodo_contacto_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_metodo_contacto_" + iRow).removeClass("scFormErrorLine");
    }
  }
