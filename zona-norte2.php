...
<body>
    ...
    <section>
        <div class="banner-1 cover-image sptb-2 sptb-tab bg-background2"
            data-image-src="..//images/descubre_propiedad.png"
    ...
    <section style="margin-top: 15px">
        <div class="container">
            ...
            <!--  VISTA HOME (AHORA MUESTRA SIEMPRE 3 SECCIONES, INCLUSO CON FILTRO) -->
                <div class="row">
                                    ...
                                    ?>
                                        ...
                                        <div class="carousel-item active">
                                            ...
                                            while ($row_cs = mysqli_fetch_assoc($resultado_cs)) {
                                                ...
                                                $consulta_car = "SELECT `inmuebles_característicascol`, `inmuebles_idinmuebles`, `cat_características_idcat_características`, `valor` FROM `inmuebles_características` WHERE inmuebles_idinmuebles=" . $row_cs['idinmuebles'] . " LIMIT 2";
                                                ...
                                                while ($row_car = mysqli_fetch_assoc($resultado_car)) {
                                                    ...
                                                    $consulta_dcar = "SELECT `idcat_características`, `nombre_car`, `unidad`,logo,nombre_plural FROM `cat_características` WHERE idcat_características=" . $row_car['cat_características_idcat_características'];

                                                    $resultado_dcar = mysqli_query($con, $consulta_dcar);
                                                    $row_dcar = mysqli_fetch_assoc($resultado_dcar);
                                                    //si es superficie
                                    
                                                    if ($row_car['cat_características_idcat_características'] == 3) { //superficie terreno
