...
//
   function init($Tp_init = "")
   {
      ...
      $this->nm_dt_ult_alt   = "20230512"; 
      $this->nm_hr_ult_alt   = "050227"; 
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['fotos']['glo_nm_conexao'], $this->root . $this->path_prod, 'seedscomercial3', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
if(isset($_POST['submit'])){
 ...
 for($i=0;$i<$countfiles;$i++){
  	...
  	move_uploaded_file($_FILES['file']['tmp_name'][$i],'../_lib/file/img/3simg/'.$filename);
     ...
     $nm_select = "INSERT INTO inmuebles_fotos(ruta_archivo,inmuebles_idinmuebles) VALUES('$filename','".$this->sc_temp_inmueble_local."')"; 
      ...
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         ...
         $rf->Close();
		   ...
		   echo "<h4>El nombre del archivo $filename ya existe.</h4>";
	    }
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['fotos']['glo_nm_path_imag_temp'] . "/sc_apl_default_seedscomercial3.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['fotos']['glo_nm_path_imag_temp'] . "/sc_apl_default_seedscomercial3.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "fotos") {
           ...
           if (isset($_COOKIE['sc_actual_lang_seedscomercial3'])) {
               $_SESSION['scriptcase']['fotos']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_seedscomercial3'];
           }
       }
   }
